---
title: "Get Started with Mintlify in Five Minutes"
description: "Learn how to install the Mintlify CLI, preview a docs site locally, edit your first page, and deploy with the GitHub app in just a few steps."
